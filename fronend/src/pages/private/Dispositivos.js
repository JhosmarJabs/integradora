...
const Dispositivos = () => {
  ...
  return (
    <div>
      ...
      <p style={textStyles.paragraph}>Gestiona todos tus dispositivos conectados en un solo lugar.</p>
              ...
              <Row className="align-items-center">
                <Col md={9}>
                  ...
                  <p style={{ 
                    ...
                    {devices.filter(d => d.status === 'active').length} dispositivos activos de {devices.length} totales
                  </p>
                </Col>
