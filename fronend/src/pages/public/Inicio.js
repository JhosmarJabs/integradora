...
const Inicio = () => {
  ...
  useEffect(() => {
    ...
    const persianaInteligente = {
      ...
      description: "Control automático de luz natural con programación horaria y sensores de luz.",
      price: 349.99,
      category: "Domótica",
      stock: 12,
      brand: "SmartShade",
  ...
  const customStyles = {
    heroSection: {
      backgroundImage: "linear-gradient(135deg, rgba(13, 27, 42, 0.85) 0%, rgba(27, 38, 59, 0.9) 100%), url('https://images.unsplash.com/photo-1558002038-1055e2debb44?q=80&w=2940')",
    ...
    categoriesSection: {
      backgroundImage: "linear-gradient(135deg, rgba(65, 90, 119, 0.95) 0%, rgba(27, 38, 59, 0.9) 100%), url('https://images.unsplash.com/photo-1558591710-4b4a1ae0f04d?q=80&w=2587')",
      backgroundSize: "cover",
      backgroundPosition: "center",
    ...
    starProductSection: {
      backgroundImage: "linear-gradient(135deg, rgba(65, 90, 119, 0.05) 0%, rgba(27, 38, 59, 0.02) 100%)",
    ...
    testimonialsPattern: {
      ...
      right: 0,
      bottom: 0,
      backgroundImage: "url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI0MCIgaGVpZ2h0PSI0MCI+CjxyZWN0IHdpZHRoPSI0MCIgaGVpZ2h0PSI0MCIgZmlsbD0ibm9uZSI+PC9yZWN0Pgo8Y2lyY2xlIGN4PSIyMCIgY3k9IjIwIiByPSIxIiBmaWxsPSIjMGQxYjJhIiBvcGFjaXR5PSIwLjA1Ij48L2NpcmNsZT4KPC9zdmc+')",
      opacity: 0.8,
      zIndex: 0,
    },
    ctaSection: {
    ...
    ctaOverlay: {
      ...
      right: 0,
      bottom: 0,
      backgroundImage: "radial-gradient(circle at 30% 40%, rgba(255,230,7,0.05) 0%, rgba(255,230,7,0) 50%)",
      zIndex: 1,
    },
    yellowButton: {
    ...
    categoryOverlay: {
      ...
      right: 0,
      bottom: 0,
      background: "linear-gradient(to top, rgba(13, 27, 42, 0.8) 0%, rgba(13, 27, 42, 0.4) 50%, rgba(13, 27, 42, 0.1) 100%)",
      display: "flex",
    ...
    featureIcon: {
      fontSize: "2.5rem",
      background: "linear-gradient(135deg, rgba(65, 90, 119, 0.08) 0%, rgba(65, 90, 119, 0.03) 100%)",
      width: "80px",
      height: "80px",
      lineHeight: "80px",
      borderRadius: "50%",
        ...
        <section className="py-5" style={customStyles.starProductSection}>
          ...
          <Container className="py-5" style={{position: "relative", zIndex: 2}}>
            <div className="text-center mb-5">
              ...
              <p className="lead text-muted mx-auto mb-5" style={{maxWidth: "700px"}}>
                La solución perfecta para controlar la luz natural y aumentar la eficiencia energética de tu hogar.
              </p>
            </div>
            ...
            <Row className="align-items-center g-5">
              ...
              <Col lg={6} className="animate-in" style={{animationDelay: "0.5s"}}>
                <div>
                  <h3 className="fs-2 fw-bold mb-4" style={{color: colors.primaryDark}}>{productoEstrella.title}</h3>
                  <p className="fs-5 mb-4" style={{color: colors.primaryLight}}>
                    {productoEstrella.description}
                  </p>
                  
                  <div className="mb-4">
                    <div className="d-flex mb-2">
                      <div className="fs-3 fw-bold me-3" style={{color: colors.primaryDark}}>
                  ...
                  <div className="mb-4">
                    <h4 className="fs-5 fw-bold mb-3" style={{color: colors.primaryMedium}}>
                      Características principales:
                    </h4>
                    <Row className="g-3">
                ...
                <Card className="testimonial-card shadow">
                  <Card.Body className="p-4 position-relative">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      />
                      <div>
                        <h5 className="mb-1" style={{color: colors.primaryDark}}>
                          {testimonio.nombre}
                        </h5>
      ...
      <section className="py-5 text-white" style={customStyles.ctaSection}>
        ...
        <Container className="py-5 text-center" style={{position: "relative", zIndex: 2}}>
          ...
          <p className="lead opacity-75 mb-5 mx-auto animate-in" style={{maxWidth: "700px", animationDelay: "0.5s"}}>
            Únete a nuestra comunidad y recibe acceso a ofertas exclusivas, consejos para optimizar tu hogar inteligente y mucho más.
          </p>
