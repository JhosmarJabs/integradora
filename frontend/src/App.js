...
import ProductoDetalle from "./pages/public/ProductoDetalle.js"; // Importamos el componente de detalle
      ...
      <div className="App">
        <Routes>
          ...
          <Route path="/admin" element={<AdminLayout />}>
            ...
            {/* Información */}
            <Route
              path="informacion/modificacion"
              element={<InformacionModificacion />}
            />
