  ...
  const styles = {
    ...
    timelineItemHover: {
      ...
      backgroundColor: `rgba(${parseInt(
        colors.primaryLight.slice(1, 3),
        16
      )}, ${parseInt(colors.primaryLight.slice(3, 5), 16)}, ${parseInt(
        colors.primaryLight.slice(5, 7),
        16
      )}, 0.05)`,
  ...
  const timelineData = [
    {
      year: "2024",
      description:
        "Lanzamiento de nuestra primera colección de diseños personalizados.",
      icon: "🚀",
    },
    {
      year: "2025",
      description:
        "Expansión de nuestra presencia en el mercado nacional con proyectos destacados.",
      icon: "🌎",
    },
    {
      year: "2025",
      description:
        'Reconocimiento como "Mejor Empresa de Diseño" en los Premios Nacionales de Innovación.',
      icon: "🏆",
    },
  ];
      ...
      <Container style={layout.sectionPadding}>
        ...
        <Row className="align-items-center" style={styles.section}>
          <Col md={6} className="mb-4 mb-md-0">
            ...
            >
              <Image
                src={`${API_URL}/uploads/empresa/Huejutla_de_Reyes.jpg `}
              ...
              >
                <h4 style={{ color: colors.white, marginBottom: "5px" }}>
                  Innovación desde el primer día
                </h4>
                <p
                  style={{
                    color: colors.white,
          ...
          <Col md={6}>
            ...
            >
              ...
              <p style={styles.paragraph}>
                JADA Company nació en 2025 en Huejutla de Reyes, Hidalgo,
                México, con el propósito de revolucionar el mundo del diseño al
                ofrecer soluciones que combinan creatividad, funcionalidad y
                sostenibilidad.
              </p>
              ...
              {[
                {
                  ...
                  content:
                    "Mejorar la calidad de vida con persianas de alta calidad que combinan diseño, funcionalidad y sostenibilidad.",
                },
                {
                  title: "Visión",
                  color: colors.primaryMedium,
                  content:
                    "Ser la empresa líder en el mercado europeo de persianas, con presencia en más de 10 países para 2030.",
                },
                {
                  title: "Valores",
                  color: colors.primaryDark,
          ...
          <Row className="align-items-center g-4">
            <Col md={6} className="order-md-2 mb-4 mb-md-0">
              ...
              >
                ...
                <Image
                  src={`${API_URL}/uploads/empresa/exelencia.png`}
            ...
            <Col md={6} className="order-md-1">
              ...
              >
                ...
                <p style={{ ...styles.paragraph, marginBottom: "25px" }}>
                  En JADA Company, combinamos diseño personalizado, tecnología
                  avanzada y un compromiso sólido con la sostenibilidad para
        ...
        <div style={styles.policySection}>
          <Row className="text-center">
            <Col>
              ...
              >
                Conoce nuestras políticas de privacidad, términos de servicio y
                garantía de productos. Nos comprometemos con la transparencia y
                la protección de los datos de nuestros clientes.
              </p>
              <button
                style={{
                  ...styles.policyButton,
                  backgroundColor: policyButtonHover
                    ? colors.white
                    : colors.primaryDark,
