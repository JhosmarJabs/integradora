...
import { eyeOffOutline, eyeOutline, mailOutline, lockClosedOutline, callOutline, logoGoogle, logoFacebook} from 'ionicons/icons';
        ...
        <div style={styles.formWrapper}>
            ...
            {isLogin && (
                ...
                <Form onSubmit={handleLoginSubmit}>
                    ...
                    >
                        <IonIcon icon={logoGoogle} style={styles.socialIcon} />
                        Google
                    </button>
                    <button 
                        type="button" 
                    ...
                    >
                        <IonIcon icon={logoFacebook} style={styles.socialIcon} />
                        Facebook
                    </button>
                    </div>
                ...
                <div style={styles.termsText}>
                    ...
                    <span style={styles.highlight}>Términos de Servicio</span>{' '}
                    y{' '}
                    <span style={styles.highlight}>Política de Privacidad</span>
                </div>
                </>
            )}
